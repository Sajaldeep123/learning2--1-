...
const getAIResponse = (message) => {
  ...
  if (lowerMessage.includes("career") || lowerMessage.includes("job") || lowerMessage.includes("profession")) {
    return "I'd be happy to help with your career planning! To give you the best guidance, could you tell me about your interests, current skills, or the field you're considering? I'll create a personalized roadmap for you.";
  }
